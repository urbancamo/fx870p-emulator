5 GOTO 10010
10 DATA Coulomb's law (electric f.),"F=k��Q�Q�/r� , k�=9*10�[N�m�/C�]",10,20,
20 DATA Electric field,"E=V/d , F=QE , W=QV",10,30,
30 DATA Capacitance,"Q=CV , C=���S/d",20,40,
40 DATA Capacitance,"C=C�+C� , 1/C=1/C�+1/C�",30,50,
50 DATA Dielectric constant,"D=��E , C=�C�",40,60,
60 DATA Electrostatic energy,U=1/2�QV=1/2�CV�,50,70,
70 DATA Electrons in electric field,"a=QE/m , 1/2�mv�=eV",60,80,
80 DATA Coulomb's law (magnetic f.),"F=k��m�m�/r� , k�=10�/(4�)�",70,90,
90 DATA Magnetic field,"H=I/2�r , H=I/2r , H=nI",80,100,
100 DATA Magnetic field,F=��IHl=IBl,90,110,
110 DATA Magnetic flux density,B=m/4�r�=��H,100,120,
120 DATA Lorentz force,"F=QvB , r=mv/QB",110,130,
130 DATA Electrons in magnetic field,"1/2�mv�=Q�B�r�/2m , �=v/r=QB/m",120,140,
140 DATA Faraday's law of induction,V=-n��/�t,130,150,
150 DATA Electromagnetic induction,"V=El=vBl , I=vBl/R",140,160,
160 DATA Mutual induction,V�=-M��I�/�t,150,170,
170 DATA Self-induction,V�=-L��I/�t,160,170,
