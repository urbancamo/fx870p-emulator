5 GOTO 10010
10 DATA Absolute temperature,T[K]=t[�C]+273.15,10,20,
...
90 DATA Pressure,P=1/3�nm��,80,100,1,B08C828CB0
100 DATA Internal energy,U=1/2�m��N=3/2�nRT,90,110,1,B08C828CB0
110 DATA Specific heat,"Cv=�U/�T=3R/2 , Cp=�U/�T+R=5R/2",100,120,
120 DATA Half life,N=N�(1/2)��    (x=1/T),110,130,1,40F8480000
