...
10 DATA 1/p,1,10,20
20 DATA 1/p’,t,10,30
30 DATA 1/pœ,"tœž/(n-1)!        (n=1,2,3,¥¥¥)",20,40
40 DATA 1/(pùm),eýÿþ,30,50
50 DATA 1/(p(p+m)),1/m¥(1-e›ÿþ),40,60
60 DATA 1/(p’(p+m)),1/m’¥(e›ÿþ+mt-1),50,70
...
150 DATA 1/((p+m)(p+n)),1/(n-m)¥(e›ÿþ-e›œþ),140,160
160 DATA p/((p+m)(p+n)),1/(m-n)¥(me›ÿþ-ne›œþ),150,170
170 DATA 1/(p+m)’,te›ÿþ,160,180
180 DATA 1/(p+m)œ,"1/(n-1)!¥tœže›ÿþ  (n=1,2,3,¥¥¥)",170,190
190 DATA p/(p+m)’,e›ÿþ(1-mt),180,200
200 DATA 1/(p(p+m)’),1/m’¥(1-(1+mt)e›ÿþ),190,210
210 DATA 1/(p’(p+m)’),t/m’-2/m“+2/m“¥e›ÿþ+t/m’¥e›ÿþ,200,220
...
270 DATA 1/((p+m)’+n’),1/n¥e›ÿþsinnt,260,280
...
350 DATA 1/p¥((p-m)/(p+m)),-1+2e›ÿþ,340,360
360 DATA 1/p’¥((p-m)/(p+m)),2/m-t-2/m¥e›ÿþ,350,360
