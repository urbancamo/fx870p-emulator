...
430 ON sq+1 GOSUB 950,960,970,980:LOCATE 12,1:PRINT ":ÿ=";STR$(a);:z$=INPUT$(1,@):GOTO 420
...
480 ON sq+1 GOSUB 900,910,920,930:LOCATE 12,1:PRINT ":ÿ=";STR$(a);:z$=INPUT$(1,@):GOTO 470
...
621 DATA SUMLNX,SUMýX,„ýx
630 DATA SUMY,SUMY,„y
631 DATA SUMLNY,SUMýY,„ýy
640 DATA SUMX2,SUMX2,„x’
641 DATA SUMLNX2,SUMýX2,„ýx’
650 DATA SUMY2,SUMY2,„y’
651 DATA SUMLNY2,SUMýY2,„ýy’
660 DATA SUMXY,SUMXY,„xy
661 DATA SUMLNXY,SUMýXY,„ýxy
662 DATA SUMXLNY,SUMXýY,„xýy
663 DATA SUMLNXLNY,SUMýXýY,„ýxýy
670 DATA MEANX,MEANX,„x/n
671 DATA MEANLNX,MEANýX,„ýx/n
680 DATA MEANY,MEANY,„y/n
681 DATA MEANLNY,MEANýY,„ýy/n
690 DATA SDXN,SDXN,xŽn
691 DATA SDLNXN,SDýXN,ýxŽn
700 DATA SDYN,SDYN,yŽn
701 DATA SDLNYN,SDýYN,ýyŽn
710 DATA SDX,SDX,xŽnþ
711 DATA SDLNX,SDýX,ýxŽnþ
720 DATA SDY,SDY,yŽnþ
721 DATA SDLNY,SDýY,ýyŽnþ
730 DATA LRA,LRA,a
731 DATA RA,RA,a
740 DATA LRB,LRB,b
741 DATA RB,RB,b
