1 'HFG BRACING CALCS
2 CLS:CLEAR
10 DIM C(2),I(2),O(2),W(2),LA(2),LB(2),LC(2),PLUS(2),SJ(2),JH(2),REV$(2),01(2),BRI(2),TRAV(2)
20 ANGLE 0:SET N
...
1064 IF N=2 AND C(2) <0 THEN C(2)=C(1):I(2)=I(1):O(2)=O(1):W(2)=W(1):BRI(2)=BRI(1):SYM=1:LA(2)=LA(1):LB(2)=LB(1):LC(2)1=LC(1):O1(2)=O1(1)
1065 GOTO 1110
1079 CLS
